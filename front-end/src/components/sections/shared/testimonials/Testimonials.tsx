...
import sohpie from "/images/testimonials/sophire.webp"
import matt from "/images/testimonials/matt.webp"
import andy from "/images/testimonials/andy.webp"

export interface TestimonailProps {
  title: string;
  content: string;
  author: string;
  location: string;
...
const Testimonials = () => {
  const reviews: TestimonailProps[] = [
    {
