		        ...
		        <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
		          <div className="flex flex-col self-stretch my-auto max-md:mt-10 max-md:max-w-full">
		            <div className="flex flex-col font-medium text-stone-800 max-md:max-w-full">
		              <div className="text-6xl leading-[61px] max-md:max-w-full max-md:text-4xl max-md:leading-[49px]">
		            ...
		            <div className="justify-center self-start px-8 py-5 mt-10 text-base font-bold leading-6 text-right text-gray-900 border-2 border-solid border-stone-800 rounded-[118px] max-md:px-5">
		              More About Us
		            </div>
		          </div>
		        </div>
